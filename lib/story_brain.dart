...
class StoryBrain {
  ...
  String getStory() {
    //remember _storyData is a list of Story objects. That's why we can use dot operator
  ...
  //for when the end of the story is reached
  void restart() => storyNumber = 0;

  //move to next story based on user's choice
